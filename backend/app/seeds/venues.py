...
def H(open_t, close_t, closed=()):
    """Same hours every day, minus `closed` days. close < open = past midnight."""
    days = ["mon", "tue", "wed", "thu", "fri", "sat", "sun"]
    return {d: ([open_t, close_t] if d not in closed else None) for d in days}


def V(name, area, lat, lng, category, hours, price, tags, wheelchair=True):
    return {
        "name": name, "area": area, "lat": lat, "lng": lng, "category": category,
        "hours": hours, "price_band": price, "tags": tags,
        "accessibility": {"wheelchair": wheelchair, "step_free": wheelchair},
    }
...
VENUES = [
    ...
    V("Pinakothek der Moderne", "Maxvorstadt", 48.1471, 11.5723, "museum", H("10:00", "18:00", closed=("mon",)), "low",
      ["indoor", "art", "quiet"]),
    V("Lenbachhaus", "Maxvorstadt", 48.1466, 11.5636, "museum", H("10:00", "18:00", closed=("mon",)), "low",
      ["indoor", "art"]),
    V("Alte Pinakothek", "Maxvorstadt", 48.1483, 11.5700, "museum", H("10:00", "18:00", closed=("mon",)), "low",
      ["indoor", "art", "quiet"]),
    ...
    V("Theresa Grill", "Maxvorstadt", 48.1448, 11.5740, "restaurant", H("18:00", "01:00", closed=("sun",)), "high",
      ["indoor", "serves_alcohol", "steak"], wheelchair=False),
    V("Cotidiano Schellingstraße", "Maxvorstadt", 48.1513, 11.5689, "cafe", H("08:00", "22:00"), "mid",
      ["indoor", "brunch", "vegetarian_friendly"]),
    V("Atelier F Keramikstudio", "Maxvorstadt", 48.1525, 11.5658, "craft_studio", H("12:00", "20:00", closed=("mon", "sun")), "mid",
      ["indoor", "craft", "beginner_friendly"], wheelchair=False),
    V("Münchner Schachsalon", "Maxvorstadt", 48.1495, 11.5712, "club_room", H("14:00", "22:00"), "low",
      ["indoor", "games", "quiet"]),
    V("Augustiner-Keller", "Maxvorstadt", 48.1437, 11.5510, "biergarten", H("10:00", "00:00"), "mid",
      ["outdoor", "serves_alcohol", "bavarian", "big_groups"]),

    # ---------------- Glockenbach (48.129, 11.572) ----------------
    V("Werkstattkino", "Glockenbach", 48.1276, 11.5740, "cinema", H("18:00", "00:00"), "low",
      ["indoor", "film", "indie"], wheelchair=False),
    ...
    V("Holy Home", "Glockenbach", 48.1289, 11.5728, "bar", H("19:00", "03:00"), "mid",
      ["indoor", "serves_alcohol", "late_night"], wheelchair=False),
    V("Bapas", "Glockenbach", 48.1301, 11.5745, "restaurant", H("17:00", "01:00", closed=("mon",)), "mid",
    ...
    V("Vits der Kaffee", "Glockenbach", 48.1330, 11.5779, "cafe", H("08:30", "18:30", closed=("sun",)), "mid",
    ...
    V("Studio Ton", "Glockenbach", 48.1265, 11.5683, "craft_studio", H("11:00", "19:00", closed=("mon",)), "mid",
      ["indoor", "craft", "pottery", "beginner_friendly"]),
    V("Deutsches Museum Innenhof", "Glockenbach", 48.1299, 11.5834, "museum", H("09:00", "17:00"), "mid",
      ["indoor", "science"]),
    V("Baader Café", "Glockenbach", 48.1290, 11.5786, "cafe", H("09:00", "01:00"), "mid",
      ["indoor", "serves_alcohol", "brunch", "literary"]),
    V("Kletterinsel Süd", "Glockenbach", 48.1240, 11.5660, "boulder_gym", H("08:00", "23:00"), "mid",
      ["indoor", "sports", "beginner_friendly"]),

    # ---------------- Haidhausen (48.131, 11.598) ----------------
    V("Jazzclub Unterfahrt", "Haidhausen", 48.1308, 11.6010, "music_venue", H("19:00", "01:00", closed=("mon",)), "mid",
    ...
    V("Einstein Boulderhalle", "Haidhausen", 48.1289, 11.6043, "boulder_gym", H("07:00", "00:00"), "mid",
      ["indoor", "sports", "beginner_friendly"]),
    V("Café Maria", "Haidhausen", 48.1295, 11.5972, "cafe", H("09:00", "19:00", closed=("mon",)), "low",
    ...
    V("Lothringer 13 Halle", "Haidhausen", 48.1287, 11.5990, "gallery", H("11:00", "19:00", closed=("mon", "tue")), "low",
      ["indoor", "art", "free"]),
    V("Buchhandlung & Lesecafé Anna", "Haidhausen", 48.1316, 11.6022, "cafe", H("10:00", "20:00", closed=("sun",)), "low",
      ["indoor", "books", "quiet"]),
    ...
    V("Weinbar Rotwild", "Haidhausen", 48.1330, 11.5985, "bar", H("18:00", "01:00", closed=("sun", "mon")), "high",
      ["indoor", "serves_alcohol", "wine", "quiet"], wheelchair=False),
    ...
    V("Alter Simpl", "Schwabing", 48.1530, 11.5800, "bar", H("17:00", "03:00"), "mid",
    ...
    V("Leopold Vinothek", "Schwabing", 48.1580, 11.5822, "bar", H("16:00", "00:00", closed=("sun",)), "high",
      ["indoor", "serves_alcohol", "wine"]),
    V("Kleinhesseloher See Runde", "Schwabing", 48.1565, 11.5950, "park", H("00:00", "23:59"), "low",
      ["outdoor", "free", "running", "lake"]),
    V("Atelier Lichtspiel Fotostudio", "Schwabing", 48.1598, 11.5781, "craft_studio", H("13:00", "21:00", closed=("mon",)), "mid",
      ["indoor", "photography", "workshops"], wheelchair=False),
    ...
    V("Schwabinger Brettlspiele", "Schwabing", 48.1633, 11.5840, "boardgame_cafe", H("15:00", "00:00", closed=("tue",)), "low",
      ["indoor", "board_games", "family_friendly"]),
    V("Ukulele & Co Musikraum", "Schwabing", 48.1607, 11.5755, "club_room", H("16:00", "22:00", closed=("sun",)), "low",
